...
- **Node.js 22.13+** and npm (the CI build uses Node 22). Some dependencies
  declare a `^22.13.0` engine floor, so earlier 22.x patches can trip
  `EBADENGINE` warnings or strict installs.
